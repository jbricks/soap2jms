 ...
 * generated in the com.github.soap2jms.common.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _AcknowledgeMessagesResponse_QNAME = new QName("http://soap2jms.github.com/common/ws", "acknowledgeMessagesResponse");
    private final static QName _WsJmsException_QNAME = new QName("http://soap2jms.github.com/common/ws", "wsJmsException");
    private final static QName _SendMessagesResponse_QNAME = new QName("http://soap2jms.github.com/common/ws", "sendMessagesResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.github.soap2jms.common.ws
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link WsJmsIdAndStatusList }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://soap2jms.github.com/common/ws", name = "acknowledgeMessagesResponse")
    public JAXBElement<WsJmsIdAndStatusList> createAcknowledgeMessagesResponse(WsJmsIdAndStatusList value) {
        return new JAXBElement<WsJmsIdAndStatusList>(_AcknowledgeMessagesResponse_QNAME, WsJmsIdAndStatusList.class, null, value);
    }
    ...
    public JAXBElement<WsJmsIdAndStatusList> createSendMessagesResponse(WsJmsIdAndStatusList value) {
        return new JAXBElement<WsJmsIdAndStatusList>(_SendMessagesResponse_QNAME, WsJmsIdAndStatusList.class, null, value);
    }
