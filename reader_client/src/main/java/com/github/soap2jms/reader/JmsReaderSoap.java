...
public class JmsReaderSoap extends Service {
	...
	public JmsReaderSoap(final String wsdlLocation) throws MalformedURLException {
		super(new URL(wsdlLocation), JMSREADERSOAP_QNAME);
	}

	public JmsReaderSoap(final URL wsdlLocation) {
		super(wsdlLocation, JMSREADERSOAP_QNAME);
	}

	public JmsReaderSoap(final URL wsdlLocation, final QName serviceName) {
		super(wsdlLocation, serviceName);
	}

	public JmsReaderSoap(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
		super(wsdlLocation, serviceName, features);
	}

	public JmsReaderSoap(final URL wsdlLocation, final WebServiceFeature... features) {
