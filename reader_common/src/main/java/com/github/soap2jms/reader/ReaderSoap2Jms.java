...
import com.github.soap2jms.reader_common.MessageIdAndStatus;
import com.github.soap2jms.reader_common.ObjectFactory;
...
public interface ReaderSoap2Jms {
     ...
     * @param messageId
     * @return
     *     returns java.util.List<com.github.soap2jms.reader_common.MessageIdAndStatus>
     */
     ...
     * @param queueName
     * @return
     *     returns com.github.soap2jms.reader_common.RetrieveMessageResponseType
     */
